...
class DayCell extends _react.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "handleTouchEvent", event => {
      const {
        day,
        disabled,
        onMouseDown,
      ...
      switch (event.type) {
        case 'touchmove':
          {
            const targetElements = document.elementsFromPoint(event.touches[0].clientX, event.touches[0].clientY);
  ...
  render() {
    ...
    }), !this.props.isWeekNumber && this.renderSelectionPlaceholders(), !this.props.isWeekNumber && this.renderPreviewPlaceholder(), /*#__PURE__*/_react.default.createElement("span", {
      className: this.props.styles.dayNumber
    }, dayContentRenderer?.(this.props.day) || /*#__PURE__*/_react.default.createElement("span", null, (0, _dateFns.format)(this.props.day, this.props.isWeekNumber ? 'I' : this.props.dayDisplayFormat))));
  }
}
...
DayCell.propTypes = {
  ...
  isWeekNumber: _propTypes.default.bool,
  color: _propTypes.default.string,
